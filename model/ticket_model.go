package model  //ticket  ticket    //api
//import "time"

// db models

// Ticket Structure for ticket
type Ticket struct {
    ...
    Title  string  `gorm:"comment:'Ticket Title'" json:"title" form:"title"` // Ticket Title
...
// TicketListReq List request parameters for ticket
...
// TicketDetailReq Detail request parameters for ticket
type TicketDetailReq struct {
    Id int `gorm:"id;comment:'Primary Key'" json:"id" form:"id"` // Primary Key
}

// TicketAddReq Add request parameters for ticket
type TicketAddReq struct {
    ...
    Title  string  `gorm:"title;comment:'Ticket Title'" json:"title" form:"title"` // Ticket Title
...
// TicketEditReq Edit request parameters for ticket
type TicketEditReq struct {
    ...
    Title  string  `gorm:"column:title;comment:'Ticket Title'" json:"title" form:"title"` // Ticket Title
...
// TicketChangeReq Change request parameters for ticket
type TicketChangeReq struct {
    ...
    Title  string  `gorm:"-" json:"title" form:"title"` // Ticket Title
...
// TicketIdReq ID request parameters for ticket
type TicketIdReq struct {
    Id int `gorm:"id;comment:'Primary Key'" json:"id" form:"id" binding:"required"` // Primary Key
}

// TicketIdsReq IDs request parameters for ticket
type TicketIdsReq struct {
...
// TicketResp Response information for ticket
